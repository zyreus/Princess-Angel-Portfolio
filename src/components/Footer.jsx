function Footer() {
  return (
    <footer className="mt-12 border-t border-purple-100 bg-white">
      <div className="mx-auto flex w-full max-w-6xl flex-col items-center justify-between gap-3 px-4 py-6 text-center md:flex-row md:px-6 md:text-left">
        <div>
          <p className="text-sm font-semibold text-purple-700">Princess Angel Paslot</p>
          <p className="text-sm text-gray-700">princessangel.paslot@gmail.com</p>
        </div>
